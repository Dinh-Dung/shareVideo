                                ...
                                : (
                                    <div className={cx('uploader')} >
                                        <div className={cx('upload')}>
                                            <input type="file" id='upload' onChange={onUploadFile} style={{ display: 'none' }} ref={inputRef} />
                        ...
                        <div className={cx('form')}>
                            ...
                            <div className={cx('chose-wrapper')}>
                                ...
                                <div className={cx('select')} style={{ width: '300px', height: '36px' }}>
                                    <select value={uploadForm.user_request_status} onChange={e => setUploadForm(prev => ({ ...prev, user_request_status: e.target.value }))} >
                                        <option className={cx('option')} value="public">Public</option>
                                        <option className={cx('option')} value="private">Private</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className={cx('chose-wrapper')}>
                                ...
                                <div className={cx('select')} style={{ width: '300px', height: '36px' }}>
                                    <select value={uploadForm.category_id} onChange={e => setUploadForm(prev => ({ ...prev, category_id: Number(e.target.value) }))} >
                                        {categoryList.map((category, id) => (
                                            <option key={id} className={cx('option')} value={category.id}>{category.name}</option>
                                        ))}
                                    </select>
                                </div>
                            </div>
